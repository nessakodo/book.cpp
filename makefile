...
# created to the list.
TESTS = getters_test setters_test mainRunner_test estimatedWeight_test main
...
Book.o : $(USER_DIR)/Book.cpp $(GTEST_HEADERS)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -c $(USER_DIR)/Book.cpp

mainRunner.o : $(USER_DIR)/mainRunner.cpp $(USER_DIR)/Book.cpp $(GTEST_HEADERS)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -c $(USER_DIR)/mainRunner.cpp

### STEP 2: Compile test's source file into an object file ###

getters_test.o : $(TEST_DIR)/getters_test.cpp \
                    $(GTEST_HEADERS)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -c $(TEST_DIR)/getters_test.cpp

### STEP 3: Link the source object file with the test object file, link googletest with them, and spawn an executable ###

getters_test : Book.o getters_test.o gtest_main.a
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -lpthread $^ -o $@


## The steps are repeated for each unit test. ##

setters_test.o : $(TEST_DIR)/setters_test.cpp \
                     $(GTEST_HEADERS)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -c $(TEST_DIR)/setters_test.cpp

setters_test : Book.o setters_test.o gtest_main.a
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -lpthread $^ -o $@


estimatedWeight_test.o : $(TEST_DIR)/estimatedWeight_test.cpp \
                     $(GTEST_HEADERS)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -c $(TEST_DIR)/estimatedWeight_test.cpp

estimatedWeight_test : Book.o estimatedWeight_test.o gtest_main.a
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -lpthread $^ -o $@

mainRunner_test.o : $(TEST_DIR)/mainRunner_test.cpp \
                     $(GTEST_HEADERS)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -c $(TEST_DIR)/mainRunner_test.cpp

mainRunner_test : Book.o mainRunner.o mainRunner_test.o gtest_main.a
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -lpthread $^ -o $@


## To build the main program, first call the build targets for any object files that need to be linked, then the main.cc file. ##

main : Book.o mainRunner.o $(USER_DIR)/main.cpp
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -lpthread $^ -o $@
...
run_all_tests : run_getter_test run_setter_test run_weight_test run_main_test

run_main_test : mainRunner_test
	./mainRunner_test

run_getter_test : getters_test
	./getters_test

run_setter_test : setters_test
	./setters_test

run_weight_test : estimatedWeight_test
	./estimatedWeight_test
